...
const app = express();
const PORT = 5000;
const SECRET_KEY = process.env.SECRET_KEY || 'your_secret_key'; // Use an environment variable for the secret key
...
const users = [
    {
        email: "buhai@gmail.com",
        password: bcrypt.hashSync('megapassword', 8),
        role: "ADMIN",
        permissions: ["WRITE", "READ"]
    },
    {
        email: "buhaiv2@gmail.com",
        password: bcrypt.hashSync('ultrapassword', 8),
        role: "READER",
        permissions: ["READ"]
    }
];
